...
export default function HomePage() {
  ...
  return <main><section className="hero"><div className="hero-copy"><span className="eyebrow"><span className="tiny-star"><CelebrationMark size={21} /></span> CHHATTISGARH’S CELEBRATION BOOKING PLATFORM</span><h1>Plan. Book.<br /><em>Celebrate.</em></h1><p>Find beautiful stays, celebration spaces and event services across Chhattisgarh. A place for every occasion.</p><div className="hero-note"><span className="note-icon"><Check size={14} /></span> Launching {site.launch}</div><div className="hero-actions"><a className="button button-primary" href={site.signup}>Create an account <ArrowUpRight size={16} /></a><Link className="text-button" href="/signup?role=vendor">List your property <ArrowUpRight size={15} /></Link></div></div><div className="hero-photo"><div className="photo-label"><span className="live-dot" /> CHHATTISGARH, AT ITS MOST CELEBRATORY</div><div className="photo-caption"><span>Your people.<br /><em>Your kind of place.</em></span><span className="photo-circle"><ArrowUpRight size={25} /></span></div></div><span className="hero-doodle" aria-hidden="true"><CelebrationMark size={64} /></span></section>
